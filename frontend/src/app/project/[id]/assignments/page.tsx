  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-zinc-500 mt-1">Define qué evaluador trabajará cada tipo de evaluación del proyecto.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5">
        {users.map(user => {
          ...
          return (
            <Card key={user.id} className="bg-white/[0.01] border-white/5">
